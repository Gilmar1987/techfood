      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/orders/new"
            className="bg-orange-700 hover:bg-orange-800 transition-colors rounded-2xl p-6 flex flex-col gap-3">
            <span className="text-3xl">🛒</span>
            <h2 className="text-lg font-semibold text-white">Fazer Pedido</h2>
            <p className="text-sm text-white">Escolha produtos e finalize seu pedido.</p>
          </Link>
