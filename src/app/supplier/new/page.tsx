      ...
      <div className="max-w-md mx-auto">
        ...
        >
          {[
            ...
            { id: "latitude", label: "Latitude", value: latitude, set: setLatitude, type: "number", placeholder: "-23.5505" },
            { id: "longitude", label: "Longitude", value: longitude, set: setLongitude, type: "number", placeholder: "-46.6333" },
          ].map((field) => (
