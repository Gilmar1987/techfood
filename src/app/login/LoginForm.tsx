...
export type Mode = "cpf" | "cnpj" | "admin";
...
// O modo inicial chega pronto do Server Component, que lê a query string.
// Usar `useSearchParams()` aqui obrigaria a envolver a página em <Suspense>
// e tirava o /login do prerender.
