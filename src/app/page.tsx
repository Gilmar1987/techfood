...
export default function Home() {
  return (
    <main className="min-h-screen bg-zinc-50 dark:bg-black font-sans">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-32 bg-white dark:bg-zinc-950 border-b border-zinc-100 dark:border-zinc-900">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl">
          ...
          <div className="bg-zinc-50 dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-8 flex flex-col items-center gap-4">
            ...
            <Link href="/login?mode=cpf" className="w-full h-10 rounded-full bg-orange-700 text-white text-sm font-semibold flex items-center justify-center hover:bg-orange-800 transition-colors">
              Entrar com CPF
            </Link>
            <Link href="/customer/new" className="text-sm text-orange-700 font-medium hover:underline">
        ...
        <p className="mt-8 text-xs text-zinc-600 dark:text-zinc-400">
          Administrador?{" "}
          <Link href="/login?mode=admin" className="text-zinc-700 dark:text-zinc-300 hover:underline">
            Acesse aqui
          </Link>
        </p>
      </section>
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-100 dark:border-zinc-900 px-6 py-8 text-center text-xs text-zinc-600 dark:text-zinc-400">
